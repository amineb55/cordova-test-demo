...
const fr = {
  ...
  analyse: {
    badge: "Mode fondateur",
    titre: "Analyser une vidéo",
    sousTitre:
      "Dépose ta vidéo, choisis ce que tu veux en faire, et reçois ton rapport.",
    codeTitre: "Code d'accès",
    codeTexte:
      "Cette préversion est réservée. Entre ton code d'accès pour continuer.",
    codePlaceholder: "Code d'accès",
    codeValider: "Entrer",
    codeErreur: "Code d'accès invalide.",
    deposer: "Dépose ta vidéo ici",
    deposerAide: "ou clique pour choisir un fichier · MP4, MOV, WEBM · 3 minutes maximum",
    fichierChoisi: "Fichier choisi",
    changer: "Changer",
    modeTitre: "Que veux-tu faire ?",
    modeATitre: "C'est ma vidéo",
    modeADesc:
      "Diagnostic complet : verdict, corrections horodatées avec preuves, hooks réécrits dans ta langue.",
    modeBTitre: "Elle m'inspire",
    modeBDesc:
      "Décodage de sa formule, puis 5 fiches idées qui appliquent son mécanisme à ta niche — jamais une copie.",
    tiktokTitre: "C'est une capture d'écran TikTok",
    tiktokAide: "Ignore l'interface en haut et en bas de l'image",
    lancer: "Lancer l'analyse",
    envoi: "Envoi de ta vidéo…",
    patience: "L'analyse prend une à trois minutes. Garde cette page ouverte.",
    erreurTitre: "L'analyse n'a pas abouti",
    reessayer: "Réessayer",
    nouvelle: "Analyser une autre vidéo",
    supprimer: "Supprimer cette vidéo et son rapport",
    supprimee: "Analyse supprimée.",
    apiIndisponible:
      "Le moteur d'analyse n'est pas joignable pour le moment. Réessaie dans un instant.",
  },
  rapport: {
    titre: "Ton rapport",
    verdictTitre: "Verdict",
    verdictPret: "Prêt à publier",
    verdictOptimiser: "Optimiser avant de publier",
    verdictRevoir: "À revoir",
    actionsTitre: "Actions prioritaires",
    pourquoi: "Pourquoi",
    preuve: "Preuve",
    hooksTitre: "3 hooks réécrits",
    hooksAide: "dans la langue de ta vidéo",
    ecranTitre: "Texte à l'écran, en 2 temps",
    ctaTitre: "CTA de fin",
    fichesTitre: "Tes 5 fiches idées",
    scriptTitre: "Script complet",
    planTitre: "Plan de tournage",
    dureeTitre: "Durée cible",
    sensibiliteTitre: "Sensibilité plateforme",
    actualiteAlerte:
      "Actualité requise : vérifie une source fraîche avant de tourner.",
    timelineTitre: "Timeline d'attention",
    formuleTitre: "Formule décodée",
    formuleFormat: "Format",
    formuleHook: "Hook",
    formuleAccroche: "Pourquoi il accroche",
    formuleStructure: "Structure",
    formuleEmotion: "Déclencheur émotionnel",
    formulePartage: "Déclencheur de partage",
    formuleTransferable: "Ce qui est transférable",
    formuleFaiblesses: "Faiblesses observées",
    formuleMecanisme: "Pourquoi ça marche",
    transcriptTitre: "Transcript",
    telecharger: "Télécharger le rapport complet",
    mention: "estimation non calibrée",
    langues: "Langues détectées",
    cuts: "Coupures",
    zonesPlates: "Zones plates",
    visage: "Visage présent",
    silences: "Silences",
  },
  pied: {
...
const en: Dictionnaire = {
  ...
  analyse: {
    badge: "Founder mode",
    titre: "Analyze a video",
    sousTitre: "Drop your video, choose what you want from it, get your report.",
    codeTitre: "Access code",
    codeTexte: "This preview is private. Enter your access code to continue.",
    codePlaceholder: "Access code",
    codeValider: "Enter",
    codeErreur: "Invalid access code.",
    deposer: "Drop your video here",
    deposerAide: "or click to choose a file · MP4, MOV, WEBM · 3 minutes max",
    fichierChoisi: "Selected file",
    changer: "Change",
    modeTitre: "What do you want to do?",
    modeATitre: "It's my video",
    modeADesc:
      "Full diagnosis: verdict, time-coded fixes with evidence, hooks rewritten in your language.",
    modeBTitre: "It inspires me",
    modeBDesc:
      "Decode its formula, then 5 idea cards applying its mechanism to your niche — never a copy.",
    tiktokTitre: "This is a TikTok screen recording",
    tiktokAide: "Ignore the interface at the top and bottom of the frame",
    lancer: "Start the analysis",
    envoi: "Uploading your video…",
    patience: "The analysis takes one to three minutes. Keep this page open.",
    erreurTitre: "The analysis did not complete",
    reessayer: "Try again",
    nouvelle: "Analyze another video",
    supprimer: "Delete this video and its report",
    supprimee: "Analysis deleted.",
    apiIndisponible:
      "The analysis engine is unreachable right now. Please try again shortly.",
  },
  rapport: {
    titre: "Your report",
    verdictTitre: "Verdict",
    verdictPret: "Ready to post",
    verdictOptimiser: "Optimize before posting",
    verdictRevoir: "Needs rework",
    actionsTitre: "Priority actions",
    pourquoi: "Why",
    preuve: "Evidence",
    hooksTitre: "3 rewritten hooks",
    hooksAide: "in your video's language",
    ecranTitre: "On-screen text, in 2 beats",
    ctaTitre: "Closing CTA",
    fichesTitre: "Your 5 idea cards",
    scriptTitre: "Full script",
    planTitre: "Shooting plan",
    dureeTitre: "Target length",
    sensibiliteTitre: "Platform sensitivity",
    actualiteAlerte: "News-dependent: check a fresh source before shooting.",
    timelineTitre: "Attention timeline",
    formuleTitre: "Decoded formula",
    formuleFormat: "Format",
    formuleHook: "Hook",
    formuleAccroche: "Why it hooks",
    formuleStructure: "Structure",
    formuleEmotion: "Emotional trigger",
    formulePartage: "Sharing trigger",
    formuleTransferable: "What transfers",
    formuleFaiblesses: "Observed weaknesses",
    formuleMecanisme: "Why it works",
    transcriptTitre: "Transcript",
    telecharger: "Download the full report",
    mention: "uncalibrated estimate",
    langues: "Detected languages",
    cuts: "Cuts",
    zonesPlates: "Flat zones",
    visage: "Face on screen",
    silences: "Silences",
  },
  pied: {
    contact: "hello@earnaura.ai",
